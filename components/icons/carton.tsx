...
export default function Carton ({className}:{className?: string}) {
    return (
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="800px" height="800px" viewBox="0 0 53.315 53.315" xmlSpace="preserve" className={cn("fill-tertiary", className)}>
            <g>
